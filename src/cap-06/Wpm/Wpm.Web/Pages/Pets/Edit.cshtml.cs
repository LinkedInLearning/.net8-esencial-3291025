...
public class EditModel : PageModel
{
    ...
    public EditModel(WpmDbContext dbContext, [FromKeyedServices("Aws")] IStorageService storageService)
    {
    ...
    {
        var vs = (Temperature: 37.5m, Bpm: 120, Rpm: 20, date: DateTime.Now);
        Pet.AddVitalSigns(ref vs);
